        ...
        <div className="p-2 pt-[67px]">
          ...
          <div className="relative px-0 mt-1 flex items-center">
            ...
            <input
              ...
              className="pl-8 h-10 px-5 w-full py-1 flex-1 rounded-md bg-black-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-300"
            />
          </div>
