...
const features = [
  ...
  { id: 2, name: "Downloads", icon: "https://img.m156b.com/mb/h5/assets/images/icon-set/theme-icon/icon-download.svg?v=1767782599110" , link: "https://drive.google.com/uc?export=download&id=12M-ciTMnXLMjk0hyvzMnVLi_bKrEUf5Q"},
